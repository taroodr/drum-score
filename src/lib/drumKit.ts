...
export const drumKit: Instrument[] = [
  ...
  { id: "ride", label: "Ride", gridRow: 1, staffRow: 0, noteHead: "x" },
  { id: "open-hihat", label: "Open Hi-Hat", gridRow: 2, staffRow: 0, noteHead: "x" },
  { id: "hihat", label: "Hi-Hat", gridRow: 3, staffRow: 0, noteHead: "x" },
  { id: "tom1", label: "Tom 1", gridRow: 4, staffRow: 2, noteHead: "filled" },
  { id: "tom2", label: "Tom 2", gridRow: 5, staffRow: 3, noteHead: "filled" },
  { id: "tom3", label: "Tom 3", gridRow: 6, staffRow: 6, noteHead: "filled" },
